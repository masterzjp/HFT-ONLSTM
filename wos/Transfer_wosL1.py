...
x,y1,y2,y1_pad,y2_pad = pl.load(open(r'D:\E1106\pycharmModel0905\pycharmModel0905\htc-github\data\WOSDATA_txt_vector500dimsy1y2_10dim_zjp','rb'))
...
fileweights = r"D:\E1106\pycharmModel0905\pycharmModel0905\htc-github\wos\output\weights\Ay1pad_y2_best_weights.h5"
...
pl.dump(predict, open(r'D:\E1106\pycharmModel0905\pycharmModel0905\htc-github\wos\output\predictlabel\wos_layer1_predict1_2', 'wb'))
...
y1_id_pad = []
label1_id =pl.load(open(r'D:\E1106\pycharmModel0905\pycharmModel0905\htc-github\wos\output\predictlabel\wos_layer1_predict1_2','rb'))
for i in label1_id:
...
with open(r'D:\E1106\pycharmModel0905\pycharmModel0905\htc-github\wos\output\predictlabel\py1_id_pad_2', 'wb') as f:
    pl.dump(y1_pad, f)
