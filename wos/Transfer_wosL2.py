...
#######################################################################################################################
print('Loading data...')
x,y1,y2,y1_pad,y2_pad = pl.load(open(r'D:\赵鲸朋\pycharmModel0905\pycharmModel0905\htc-github\data\wos\WOSDATA_txt_vector500dimsy1y2_10dim_zjp','rb'))
pre_y1_pad = pl.load(open(r'D:\赵鲸朋\pycharmModel0905\pycharmModel0905\htc-github\wos\output\predictlabel\py1_id_pad_2','rb'))#wos第一层目录忘记改成3了，把3的放在5里面了
...
model.load_weights(r"D:\赵鲸朋\pycharmModel0905\pycharmModel0905\htc-github\wos\output\weights\Ay1pad_y2_best_weights.h5",by_name=True)
...
#######################################################################################################################
print('Train...')
fileweights = r"D:\赵鲸朋\pycharmModel0905\pycharmModel0905\htc-github\wos\output\weights\Acontent_best_weights.h5"
