...
x,y1,y2,y3,y1_pad,y2_pad,y3_pad = pl.load(open(r'D:\赵鲸朋\pycharmModel0905\pycharmModel0905\htc-github\data\DBP_txt_vector300dim_y1y2y3_10dim_zjp','rb'))
pre_y2_pad = pl.load(open(r'D:\赵鲸朋\pycharmModel0905\pycharmModel0905\htc-github\dbpedia\output\predictlabel\DB_pre_y2_id_pad_2','rb'))
########################################################################################################################
...
model.load_weights(r"D:\赵鲸朋\pycharmModel0905\pycharmModel0905\htc-github\dbpedia\output\weights\Ay1content_y2_best_weights.h5",by_name=True)
#########################
model.compile('adam', 'categorical_crossentropy', metrics=['accuracy'])
model.summary()
print('Train...')
fileweights = r"D:\赵鲸朋\pycharmModel0905\pycharmModel0905\htc-github\dbpedia\output\weights\Ay2content_y3_best_weights.h5"
