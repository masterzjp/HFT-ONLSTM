...
pre_y1_pad = pl.load(open(r'D:\赵鲸朋\pycharmModel0905\pycharmModel0905\htc-github\dbpedia\output\predictlabel\DB_pre_y1_id_pad_2','rb'))
print(pre_y1_pad[:3])
######20191124 预测标签转为真实标签
...
model.load_weights(r"D:\赵鲸朋\pycharmModel0905\pycharmModel0905\htc-github\dbpedia\output\weights\Ay1contentbest_weights.h5",by_name=True)
model.compile('adam', 'categorical_crossentropy', metrics=['accuracy'])
##################################################################
model.summary()
print('Train...')
fileweights = r"D:\赵鲸朋\pycharmModel0905\pycharmModel0905\htc-github\dbpedia\output\weights\Ay1content_y2_best_weights.h5"
...
pl.dump(predict, open('D:\赵鲸朋\pycharmModel0905\pycharmModel0905\htc-github\dbpedia\output\predictlabel\DBpedia_layer2_predict2_2', 'wb'))
...
y2_id_pad = []
label2_id =pl.load(open(r'D:\赵鲸朋\pycharmModel0905\pycharmModel0905\htc-github\dbpedia\output\predictlabel\DBpedia_layer2_predict2_2','rb'))
...
with open(r'D:\赵鲸朋\pycharmModel0905\pycharmModel0905\htc-github\dbpedia\output\predictlabel\DB_pre_y2_id_pad_2', 'wb') as f:
    pl.dump(y2_pad, f)
#######################################
