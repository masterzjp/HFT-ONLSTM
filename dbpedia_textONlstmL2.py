...
class TextONLSTM2(object):
    ...
    def get_model(self):
        ...
        embedding_word_raw = Embedding(self.max_features, self.embedding_dims, weights=[self.word_embedding_matrix],input_length=self.maxlen,trainable=False,name='embedding2')(input)
